...
int main(void)
{
  ...
  osThreadDef(ParseTask, StartParseTask, osPriorityNormal, 0, 128);
  ...
  osThreadDef(BlinkLEDTask, StartBlinkLEDTask, osPriorityNormal, 0, 128);
...
__weak void StartParseTask(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
...
__weak void StartBlinkLEDTask(void const * argument)
{
